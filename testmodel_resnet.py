...
def conv_3d_1s_kerenl(in_planes, out_planes, stride=1):
    return nn.Conv3d(in_planes,
                     out_planes,
                     kernel_size=1,
                     stride=stride,
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, out_planes, stride=1):
        ...
        if stride != 1 or in_planes != out_planes:
            self.shortcut = nn.Sequential(
                conv_3d_1s_kerenl(in_planes, out_planes, stride),
...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv1 = nn.Conv3d(n_input_channels,
                               self.in_planes,
                               kernel_size=(conv_1l_s, 7, 7),
                               stride=(conv_1l_stride, 2, 2),
                               padding=(conv_1l_s // 2, 3, 3),
                               bias=False)
